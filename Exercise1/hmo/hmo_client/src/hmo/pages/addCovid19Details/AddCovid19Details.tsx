...
//               {errors[`vaccineDates[${index}].date`] && <span className="error-message"></span>}
//             </div>
//             <div className="form-group">
...
//               {errors[`vaccineDates[${index}].manufacturer`] && <span className="error-message"></span>}
//             </div>
//           </div>
//         ))}
  ...
  return (
    <div className="add-covid19-form">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          <label>Positive Test Date:</label>
          <input type='date' {...register('positiveTestDate')} />
          {errors.positiveTestDate && <span className="error-message">Positive Test Date is required</span>}
        </div>

        <div className="form-group">
          <label>Recovery Date:</label>
          <input type='date' {...register('recoveryDate')} />
        ...
        {[...Array(4)].map((_, index) => (
          <div key={index} className="vaccine-details">
            ...
            <div className="form-group">
              ...
              <input type='date' {...register(`vaccineDates[${index}].date`)} />
            ...
            <div className="form-group">
              ...
              <input {...register(`vaccineDates[${index}].manufacturer`)} />
